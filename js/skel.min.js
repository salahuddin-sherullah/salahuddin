...
var skel = function() {
    var e = "config",
        ...
        Gt = {
            ...
            config: { breakpoints: { "*": { href: a, media: "" } }, containers: 1140, defaultState: c, events: {}, grid: { collapse: a, gutters: { vertical: 40, horizontal: 0 } }, plugins: {}, pollOnce: a, preload: a, reset: Lt, RTL: a, viewport: { width: "device-width" } },
            ...
            defaults: { breakpoint: { config: c, elements: c, test: c }, config_breakpoint: { containers: "100%", grid: {}, href: a, media: "", viewport: {} } },
            events: [],
            forceDefaultState: a,
            isInit: a,
            isStatic: a,
            ...
            extend: function(e, t) {
                var r;
                Gt[n](t, function(n) { Gt[$](t[n]) ? (Gt[$](e[n]) || (e[n] = []), Gt[X](e[n], t[n])) : typeof t[n] == b ? (typeof e[n] != b && (e[n] = {}), Gt[X](e[n], t[n])) : e[n] = t[n] })
            },
            getArray: function(e) { return Gt[$](e) ? e : [e] },
            getLevel: function(e) { return typeof e == "boolean" ? e ? 100 : 0 : parseInt(e) },
            ...
            canUse: function(e) { return Gt[t][e] && Gt[t][e].test() },
            hasActive: function(e) { var t = a; return Gt[n](e, function(n) { t = t || Gt.isActive(e[n]) }), t },
            isActive: function(e) { return Gt[R](Gt[r], Gt.sd + e) !== -1 },
            ...
            wasActive: function(e) { return Gt[R](Gt[q].lastStateId, Gt.sd + e) !== -1 },
            ...
            bind: function(e, t) { Gt[V][e] || (Gt[V][e] = []), Gt[V][e][d](t), e == At && Gt.isInit && t() },
            change: function(e) { Gt.bind(At, e) },
            trigger: function(e) {
                if (!Gt[V][e] || Gt[V][e][f] == 0) return;
                var t;
                Gt[n](Gt[V][e], function(t) { Gt[V][e][t]() })
            },
            registerLocation: function(e, t) { e == F ? t[pt] = function(e, t) { t ? this[p](e, this[mt]) : this === Gt.me[l] ? this[p](e, Gt.me) : this.appendChild(e) } : t[pt] = function(e, t) { t ? this[p](e, this[mt]) : this.appendChild(e) }, Gt[N][e] = t },
            addCachedElementToBreakpoint: function(e, n) { Gt[t][e] && Gt[t][e][i][d](n) },
            addCachedElementToState: function(e, t) { Gt[H][o][e] ? Gt[H][o][e][d](t) : Gt[H][o][e] = [t] },
            ...
            attachElements: function(e) {
                var t = [],
                    r = [],
                    i, s, o;
                Gt[n](e, function(n) { t[e[n][Vt]] || (t[e[n][Vt]] = []), t[e[n][Vt]][d](e[n]) }), Gt[n](t, function(e) {
                    if (t[e][f] == 0) return;
                    Gt[n](t[e], function(n) { Gt[lt](t[e][n]) || r[d](t[e][n]) })
                }), r[f] > 0 && Gt[Q](function() { Gt[n](r, function(e) { Gt[lt](r[e]) }) })
            },
            cacheElement: function(e) { return Gt[H][i][e.id] = e, e },
            cacheNewElement: function(e, t, n, r) { var i; return t[l] && t[l].removeChild(t), i = Gt[A](e, t, n, r), Gt.cacheElement(i) },
            detachAllElements: function(e) {
                var t, r, s = {};
                Gt[n](e, function(t) { s[e[t].id] = D }), Gt[n](Gt[H][i], function(e) {
                    if (e in s) return;
                    Gt.detachElement(e)
                })
            },
            ...
            getCachedElement: function(e) { return Gt[H][i][e] ? Gt[H][i][e] : c },
            ...
            changeState: function(s) {
                ...
                if (!Gt[H][vt][Gt[r]]) {
                    ...
                    b = "iCd" + Gt[r];
                    if (!(g = Gt[m](b))) {
                        T = [], N = [], Gt[n](Gt[t], function(e) { Gt[R](u, e) !== -1 ? T[d](".not-" + e) : N[d](".only-" + e) });
                        var yt = (T[f] > 0 ? T.join(",") + et : "") + (N[f] > 0 ? N.join(",") + et : "");
                        g = Gt[w](b, Gt[E](yt[U](/\.([0-9])/, Xt)), F, 3), c[i][d](g)
                    }
                    Gt[n](u, function(r) { Gt[t][u[r]][e][Qt] && (b = "ss" + u[r], (g = Gt[m](b)) || (g = Gt[w](b, Gt.newStyleSheet(Gt[t][u[r]][e][Qt]), F, 5)), c[i][d](g)), Gt[t][u[r]][i][f] > 0 && Gt[n](Gt[t][u[r]][i], function(e) { c[i][d](Gt[t][u[r]][i][e]) }) }), Gt[H][o][Gt[r]] && (Gt[n](Gt[H][o][Gt[r]], function(e) { c[i][d](Gt[H][o][Gt[r]][e]) }), Gt[H][o][Gt[r]] = [])
                } else c = Gt[H][vt][Gt[r]];
                Gt.detachAllElements(c[i]), Gt[ut](c[i]), Gt[Q](function() { Gt[Nt](c) }), Gt[q].state = Gt[H][vt][Gt[r]], Gt[q][r] = Gt[r], Gt.trigger(At)
            },
            getStateId: function() { if (Gt[Dt] && Gt[e].defaultState) return Gt[e].defaultState; var r = ""; return Gt[n](Gt[t], function(e) { Gt[t][e].test() && (r += Gt.sd + e) }), r },
            poll: function() {
                var e = "";
            ...
            updateState: function() {
                ...
                e = Gt[r][_](1).split(Gt.sd), Gt[n](e, function(o) {
                    s = Gt[t][e[o]];
                    if (s[i][f] == 0) return;
                    Gt[n](s[i], function(e) { Gt[H][vt][Gt[r]][i][d](s[i][e]), l[d](s[i][e]) })
                }), Gt[H][o][Gt[r]] && (Gt[n](Gt[H][o][Gt[r]], function(e) { Gt[H][vt][Gt[r]][i][d](Gt[H][o][Gt[r]][e]), l[d](Gt[H][o][Gt[r]][e]) }), Gt[H][o][Gt[r]] = []), l[f] > 0 && Gt[ut](l)
            },
            newDiv: function(e) { var t = document[k]("div"); return t[Rt] = e, t },
            newInline: function(e) { var t; return t = document[k]("style"), t.type = ht, t[Rt] = e, t },
            newMeta: function(e, t) { var n = document[k]("meta"); return n.name = e, n.content = t, n },
            newStyleSheet: function(e) { var t = document[k]("link"); return t.rel = "stylesheet", t.type = ht, t[Qt] = e, t },
            initPlugin: function(t, n) { typeof n == b && Gt[X](t[e], n), t.init && t.init() },
            registerPlugin: function(e, t) {
                if (!t) return a;
                Gt[ft][e] = t, t._ = this, t.register && t.register()
            },
            init: function(t, r) { Gt.initConfig(t), Gt.initElements(), Gt.initEvents(), Gt.poll(), r && typeof r == b && (Gt[e][ft] = r), Gt[n](Gt[ft], function(t) { Gt.initPlugin(Gt[ft][t], t in Gt[e][ft] ? Gt[e][ft][t] : c) }), Gt.isInit = D },
            initAPI: function() {
                var e, t, r = navigator.userAgent;
                Gt[q][ot] = 99, e = "other", r[L](/Firefox/) ? e = "firefox" : r[L](/Chrome/) ? e = "chrome" : r[L](/Safari/) && !r[L](/Chrome/) ? e = "safari" : r[L](/(OPR|Opera)/) ? e = "opera" : r[L](/MSIE ([0-9]+)/) ? (e = "ie", Gt[q][ot] = RegExp.$1) : r[L](/Trident\/.+rv:([0-9]+)/) && (e = "ie", Gt[q][ot] = RegExp.$1), Gt[q].browser = e, Gt[q][O] = "other", t = { ios: "(iPad|iPhone|iPod)", android: "Android", mac: "Macintosh", wp: "Windows Phone", windows: "Windows NT" }, Gt[n](t, function(e) { r[L](new RegExp(t[e], "g")) && (Gt[q][O] = e) });
                switch (Gt[q][O]) {
                    case "ios":
            ...
            initConfig: function(r) {
                ...
                }), "*" in Gt[e][t] && (Gt[Kt] = D, Gt[e][t]["*"][P] = Gt[e][P]), Gt[n](Gt[e][V], function(t) { Gt.bind(t, Gt[e][V][t]) }), o[f] > 0 && window.location.protocol != "file:" && Gt[Q](function() {
                    var e, t = document[u](F)[0],
                        r = new XMLHttpRequest;
                    Gt[n](o, function(e) { r.open("GET", o[e], a), r.send("") })
                })
            },
            ...
            initEvents: function() {
                var t;
                !Gt[e].pollOnce && !Gt[Kt] && (Gt.bind(xt, function() { Gt.poll() }), Gt.bind(T, function() { Gt.poll() })), Gt[q][O] == "ios" && Gt[Q](function() {
                    Gt.bind(T, function() {
                        var e = document[u]("input");
                        Gt[n](e, function(t) { e[t][Pt] = e[t][yt], e[t][yt] = "" }), window.setTimeout(function() { Gt[n](e, function(t) { e[t][yt] = e[t][Pt] }) }, 100)
                    })
                }), window[Jt] && Gt.bind(xt, window[Jt]), window[Jt] = function() { Gt.trigger(xt) }, window[J] && Gt.bind(T, window[J]), window[J] = function() { Gt.trigger(T) }
            },
            initUtilityMethods: function() {
                document[Y] ? ! function(e, t) { Gt[Q] = t() }(zt, function() {
                    function e(e) { s = 1; while (e = t.shift()) e() }
                    var t = [],
                        n, r = document,
                        i = ct,
                        s = /^loaded|^c/.test(r[$t]);
                    return r[Y](i, n = function() { r[bt](i, n), e() }),
                        function(e) { s ? e() : t[d](e) }
                }) : ! function(e, t) { Gt[Q] = t() }(zt, function(e) {
                    ...
                    var n = [],
                        ...
                        p = h.test(s[c]);
                    return s[f] && s[f](a, r = function() { s[bt](a, r, i), t() }, i), u && s.attachEvent(l, r = function() { /^c/.test(s[c]) && (s.detachEvent(l, r), t()) }), e = u ? function(t) {
                        self != top ? p ? t() : n[d](t) : function() {
                            try { o.doScroll("left") } catch (n) { return setTimeout(function() { e(t) }, 50) }
                            t()
                        }()
                    } : function(e) { p ? e() : n[d](e) }
                }), document[s] ? Gt[s] = function(e) { return document[s](e) } : Gt[s] = function(e) { var t = document; return t[Ft] ? t[Ft](("." + e[U](" ", " ."))[U](/\.([0-9])/, Xt)) : [] }, Array[It][R] ? Gt[R] = function(e, t) { return e[R](t) } : Gt[R] = function(e, t) {
                    ...
                    return -1
                }, Array[$] ? Gt[$] = function(e) { return Array[$](e) } : Gt[$] = function(e) { return Object[It].toString.call(e) === "[object Array]" }, Object.keys ? Gt[n] = function(e, t) { if (!e) return []; var n, r = Object.keys(e); for (n = 0; r[n]; n++) t(r[n]) } : Gt[n] = function(e, t) { if (!e) return []; var n; for (n in e) Object[It][rt].call(e, n) && t(n) }, window.matchMedia ? Gt[W] = function(e) { return e == "" ? D : window.matchMedia(e).matches } : window.styleMedia || window[Tt] ? Gt[W] = function(e) { if (e == "") return D; var t = window.styleMedia || window[Tt]; return t.matchMedium(e || "all") } : window[G] ? Gt[W] = function(e) {
                    if (e == "") return D;
            ...
            preInit: function() {
                ...
                Gt.me = e[e[f] - 1], Gt.initUtilityMethods(), Gt.initAPI(), Gt[nt](Mt, document[u](Mt)[0]), Gt[nt](F, document[u](F)[0]), Gt[Q](function() { Gt[nt]("body", document[u]("body")[0]) }), Gt[q][ot] >= 10 && Gt[lt](Gt[A]("msie-viewport-fix", Gt[E]("@-ms-viewport{width:device-width;}"), Z, 1))
            }
        };
    return Gt.preInit(), Gt[q][ot] < 9 && (Gt[Nt] = function(e) {}, Gt[E] = function(e) { var t; return t = document[k]("span"), t[Rt] = '&nbsp;<style type="text/css">' + e + "</style>", t }), Gt
}();